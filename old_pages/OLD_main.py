...
# # --- MAIN APP ---
# tab1, tab2 = st.tabs(["📝 Practice", "📉 Mistakes Log"])
...
# # TODO: Not use the English translation as an input, but use it for a hidden field that shows the translation so you can also practice your vocabulary -> potential for a third tab with vocab trainer


# with tab2:
#     st.subheader("Your Mistakes Log")
